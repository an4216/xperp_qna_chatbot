...
def get_rag_chain():
    ...
    system_prompt = (
        ...
        "당신의 임무는 문서에 포함된 질문(Q), 답변(A), 태그(T) 정보를 참고하거나, PDF 매뉴얼을 참고 및 분석하여,\n"
        "관련 태그의 전체 내용을 기반으로 다음 형식에 맞춰 가장 정확하고 실무적인 답변을 작성하는 것입니다:\n\n"
