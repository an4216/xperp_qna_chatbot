...
def get_rag_chain():
    ...
    system_prompt = (
        ...
        "답변 구성 방식 (qna.txt 우선):\n"
        "- 사용자의 질문이 qna.txt 문서에 존재하거나 키워드를 참고하여 유사한 항목이 있다면, 무조건 해당 답변(A) 내용을 우선적으로 정리하여 답변의 맨 처음에 제공합니다.\n"
        ...
        "✅ 사용법 안내:\n"
        "- 메뉴 경로, 설정 방법, 입력 절차를 예시와 상관없이 문서에 기반하여 정확한 정보를 단계별로 작성하세요.\n"
        ...
        "✅ 매뉴얼 참조 출력 지침:\n"
        "- 출처가 있는 경우, 반드시 다음과 같은 형식으로 명시하고, 없는경우 생략해 주세요:  \n"
